 ...
 */
public class CheckPatentBet {
    @BeforeClass
    public void setUp() {
        //System.setProperty("webdriver.chrome.driver", "/usr/local/bin/chromedriver");
        System.setProperty("webdriver.chrome.driver","C:\\Selenium\\chromedriver.exe");
    }
    public  void CheckPatentBetFeatures () throws  Exception {
        /* Open Game
        submit three singles with stake = 0,open multiples page, check bet name
        Set Stake > 0 for patent  bet, Start Game
        check patent stake/bet/result, Click Skip All, Click New Game
        submit three singles with stake = 0,open multiples page, check bet name,
        Set Stake > 0 for patent  bet, check patent stake/bet/
        set EW = yes for patent bet, check bet name/bet, Click Start Game
        check patent stake/bet/result, Click Skip All, Click New Game
        */
        ...
        if (betName.equals("Patent")) { // check that Patent bet present at Multiples page
            System.out.println("Patent bet is present at Multiples");
        } else System.out.println("Patent bet is not present at Multiples");
        Thread.sleep(2000);
        // change stake
        driver.findElement(By.xpath("//*[@id=\"game\"]/div[1]/section/div[2]/div/div/div[1]/div/div[2]/div[4]/div/table/tbody/tr/td[1]/table[2]/tbody/tr/td[1]/div/div[3]")).click();// Set Stake > 0 for patent  bet
        Thread.sleep(2000);
        driver.findElement(By.xpath("//*[@id=\"game\"]/div[1]/section/div[2]/div/div/div[1]/div/div[2]/div[4]/div/table/tbody/tr/td[1]/table[2]/tbody/tr/td[1]/div/div[3]")).click();// Set Stake > 0 for patent  bet
        Thread.sleep(2000);
        ...
        int bet;
        Double result;
        stake = Double.parseDouble(driver.findElement(By.xpath("//*[@id=\"game\"]/div[1]/section/div[2]/div/div/section/table[2]/tbody/tr/td[2]/div")).getText());//patent stake
        System.out.println("Stake at " + betName + " = " + stake);
        bet =  Integer.parseInt(driver.findElement(By.xpath("//*[@id=\"game\"]/div[1]/section/div[2]/div/div/section/table[2]/tbody/tr/td[1]/span")).getText().substring(6));//patent bet
        ...
        Thread.sleep(1000);
        result = Double.parseDouble(driver.findElement(By.xpath("//*[@id=\"game\"]/div[1]/section/div[2]/div/div/section/table[2]/tbody/tr/td[3]/span")).getText());//patent result
        ...
        driver.findElement(By.xpath("//*[@id=\"game\"]/div[1]/section/div[2]/div/div/div[1]/div/div[2]/div[4]/div/table/tbody/tr/td[1]/table[1]/tbody/tr/td[2]/div/div")).click();// Set EW = yes
        Thread.sleep(2000);
        // check bet name
        betName = driver.findElement(By.xpath("//*[@id=\"game\"]/div[1]/section/div[2]/div/div/div[1]/div/div[2]/div[4]/div/table/tbody/tr/td[1]/table[1]/tbody/tr/td[1]/translate/span")).getText();
        System.out.println("Bet Name = " + betName);
        // check bets
        bet =  Integer.parseInt(driver.findElement(By.xpath("//*[@id=\"game\"]/div[1]/section/div[2]/div/div/div[1]/div/div[2]/div[4]/div/table/tbody/tr/td[1]/table[1]/tbody/tr/td[3]")).getText().substring(7));//patent bet
        System.out.println("Numbers of bets at " + betName + " = " + bet);
        Thread.sleep(1000);
        ...
        stake = Double.parseDouble(driver.findElement(By.xpath("//*[@id=\"game\"]/div[1]/section/div[2]/div/div/section/table[2]/tbody/tr/td[2]/div")).getText());//patent stake
        System.out.println("Stake at " + betName + " = " + stake);
        bet =  Integer.parseInt(driver.findElement(By.xpath("//*[@id=\"game\"]/div[1]/section/div[2]/div/div/section/table[2]/tbody/tr/td[1]/span")).getText().substring(7));//patent bet
        System.out.println("Numbers of bets at " + betName + " = " + bet);
        Thread.sleep(1000);
        driver.findElement(By.xpath("//*[@id=\"game\"]/div[1]/section/div[2]/div/div/footer/a/div")).click();// Click Skip All
        Thread.sleep(1000);
    ...
    @Test
    public  void CheckPatentBet () throws Exception {
        FirstTest firstTest = new FirstTest();
        firstTest.setUp();
        firstTest.OpenLobbyRunGame();
        System.out.println("Game is opened");
        CheckPatentBetFeatures();
        firstTest.tearDown();
    }
}
